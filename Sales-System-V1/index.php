        ...
        <div class="row">
          ...
          <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
            ...
            <tr>
               ...
               <td><?php echo htmlspecialchars($row['saleslast6']); ?></td>
            ...
            <a href="adduser.html"><button type="button"class="btn btn-secondary">View Graph</button></a>
            </div>
          </div>
          <div class="col-sm-1">
          </div>
